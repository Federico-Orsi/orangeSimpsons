    ...
    return (
        <>
         ...
         <article className=''>
          ...
          <button className='max-[450px]:mt-12 mt max-[450px]:ml-0 btn-lg mt-20 ml-12 mb-20 rounded-full text-white hover:text-yellow-300 bg-black'><a className='p-2 m-auto' href="https://www.imdb.com/title/tt0462538/?ref_=ttvi_tt" target="_blank">Watch Trailer</a></button>
