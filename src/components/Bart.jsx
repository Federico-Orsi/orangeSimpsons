        ...
        <>
          ...
          { iconValidator == "" &&
           ...
           { (iconValidator == "A" || iconValidator == "B" || iconValidator == "C")  &&
            ...
            { language == false?
            <button className='max-[450px]:rounded-full max-[450px]:w-[38%] max-[450px]:h-[100px] max-[450px]:p-4 max-[450px]:m-7 max-[450px]:mt-[75px] md:p-[4rem] ml-14 mt-7 mr-28 mr bg-green-400 text-white min-[898px]:p-4 clipPathComenzar' onClick={Comenzar} data-aos="fade-left"
            data-aos-offset="100"data-aos-easing="ease-in-sine" data-aos-duration="3000">Comenzar</button>
          :  <button className='max-[450px]:rounded-full max-[450px]:w-[38%] max-[450px]:h-[100px] max-[450px]:m-7 max-[450px]:mt-[75px] max-[450px]:p-[2rem] md:p-[83px]  lg:p-12 ml-14 mt-7 mr-28 mr bg-green-400 text-white p-[49px] clipPathComenzar' onClick={Comenzar} data-aos="fade-left"
